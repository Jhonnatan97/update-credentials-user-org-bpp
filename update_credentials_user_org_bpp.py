...
account_suspended = []
account_active = []
prd_accounts = ['XXXXXXXXXXX', 'XXXXXXXXXX']
...
def main():
    ...
    for account in account_active:
        ...
        assume_role_response = sts.assume_role (
            RoleArn=f"arn:aws:iam::{account['id_account']}:role/role_name",
                ...
                if job_status and job_status[0] == 'ativo':
                    ...
                    if len (access_keys)>=2:
                        ...
                        if creation_date1>creation_date2:
                            ...
                            print (">>> Deu certo, credencial do user {} - {} - {} inativada/excluida com sucesso".format (username, access_keys, id_account_name))
                            # print(">>> A CREDENCIAL IA SER DELETADA <<<<")
                    ...
                    for item in access_keys:
                        ...
                        create_date = parser.parse(date_access) + timedelta(days=90)
                        ...
                        if datetime.now() > create_date:
                            ...
                            # print ("Deu certo, credencial do user {} inativada com sucesso".format (username, access_key_id))
                            ...
                            if account['id_account'] in prd_accounts:
                            ...
                            sts = session.client ('sts')
                            assume_role_response = sts.assume_role (
                                RoleArn="arn:aws:iam::XXXXXXXX:role/role_name",
                                RoleSessionName="AssumeRoleSession1")
                            temp_session = boto3.Session (
                                aws_access_key_id=assume_role_response['Credentials']['AccessKeyId'],
                                aws_secret_access_key=assume_role_response['Credentials']['SecretAccessKey'],
                            ...
                            print("A credencial do {} - {} - {} foi criada com sucesso na tabela 'infosec_iam_user' ".format(username, new_access_key_id, id_account_name))
                            ...
                            print ("A nova credencial do usuário {} - {} - {} foi excluida com sucesso na tabela 'infosec_iam_user'".format(username, access_key_id, id_account_name))
                            print()
                        else:
